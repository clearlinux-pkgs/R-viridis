...
Version  : 0.6.0
Release  : 33
URL      : https://cran.r-project.org/src/contrib/viridis_0.6.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/viridis_0.6.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618502033
